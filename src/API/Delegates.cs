...
/// <summary>
/// Contains delegates used by the public API. Names are prefixed with API version the delegate is meant for. 
/// </summary>
public static class Delegates
{
	...
	/// <summary>
	/// Callback for attaching custom behaviour to happens. Can be directly attached to <see cref="__EV_MakeNewHappen"/>
	/// </summary>
	...
	/// <summary>
	/// Delegate for including custom triggers. Can be directly attached to <see cref="__EV_MakeNewTrigger"/>. Make sure to check the first parameter (name) and see if it is fitting.
	/// </summary>
	...
	/// <summary>
	/// Delegate for registering metafunctions, for use in <see cref="VarRegistry.GetVar"/>. Can be directly attached to <see cref="__EV_ApplyMetafunctions"/>. Make sure to check the first parameter (name) and see if it is fitting.
	/// </summary>
